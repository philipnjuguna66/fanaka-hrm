    ...
    public function table(Table $table): Table
    {
        ...
        foreach ($temps as $payroll) {
            ...
            foreach ($payroll->temp as $index => $value) {
                ...
                if (!in_array($index, ["net_pay", 'paye', 'employee_id', "gross_pay", "net_payee", 'car_benefits', "nssf", "tax_allowable_deductions", 'housing_benefits', 'personal_relief', 'housing_relief', 'insurance_relief'])) {
                    ...
                    $columns['housing_levy_relief'] = TextColumn::make('housing_levy_relief')->numeric(2)->default($payroll->temp['housing_relief']);
                }
            }
        }
