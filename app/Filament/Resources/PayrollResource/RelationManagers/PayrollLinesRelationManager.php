    ...
    public function table(Table $table): Table
    {
        ...
        foreach ($temps as $key => $payroll) {
            ...
            foreach ($payroll->statutory as $index => $value) {
                ...
                if ("house_levy" == str($index)->slug("_")->value()) {
                    $relief["housing_relief"][$key] = TextColumn::make("housing_relief")->searchable()->default(number_format(floatval($value) * 0.15 , 2))->numeric(2);
                }
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('hoys')
                    ->getStateUsing(fn($record) => $record)->numeric(2),
                ...$relief,
